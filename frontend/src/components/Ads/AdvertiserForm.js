        ...
        <form style={{ margin: "20px" }}>
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              ...
              />
              <p class="text-danger">{formErrors.town}</p>
            </div>
          </div>
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              ...
              />
              <p class="text-danger">{formErrors.AgentRef}</p>
            </div>
          </div>
          <div className="row mb-3">
            <label
            ...
            <div className="col-sm-10">
              ...
              />
              <p class="text-danger">{formErrors.heading}</p>
            </div>
          </div>
          <div className="row mb-3">
            <label
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              ...
              />
              <p class="text-danger">{formErrors.sizeOfArea}</p>
            </div>
          </div>
          <div className="row mb-3">
            <label
            ...
            <div className="col-sm-10">
              ...
              />
              <p class="text-danger">{formErrors.priceRate}</p>
            </div>
          </div>
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              ...
              />
              <p class="text-danger">{formErrors.contactName}</p>
            </div>
          </div>
          <div className="row mb-3">
            <label
          ...
          <div className="form-group my-4">
            ...
            />
            <p class="text-danger">{formErrors.img}</p>
          </div>
